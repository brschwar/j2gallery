...
$(document).ready(function () {
	...
	$('.cancelBttn').each(function(i){
		$(this).click(function () { 
					...
					$( theElem.substring(0, indNum) + " option[value='1']").attr('selected', 'selected');
					return false;
				});
		});
	...
	/*
	var options = { 
		target:        '#formName',   // target element(s) to be updated with server response 
